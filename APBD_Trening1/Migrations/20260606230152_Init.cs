        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentComponentCode = table.Column<string>(type: "char(10)", nullable: false),
                    Amount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PCComponents", x => new { x.PCId, x.ComponentComponentCode });
                    table.ForeignKey(
                        name: "FK_PCComponents_Components_ComponentComponentCode",
                        column: x => x.ComponentComponentCode,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 20, 10, 0, 0, 0, DateTimeKind.Unspecified), "PC", 2, 24, 15.5f },
                    { 2, new DateTime(2026, 5, 18, 14, 30, 0, 0, DateTimeKind.Unspecified), "PC Pro", 1, 36, 18.2f },
                    { 3, new DateTime(2026, 4, 10, 9, 15, 0, 0, DateTimeKind.Unspecified), "PC Pro Max", 5, 12, 12f }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PCComponents_ComponentComponentCode",
                table: "PCComponents",
                column: "ComponentComponentCode");
        }
